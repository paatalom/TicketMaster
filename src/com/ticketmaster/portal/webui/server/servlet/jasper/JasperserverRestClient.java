...
public final class JasperserverRestClient {
	...
	// LoggerFactory.getLogger(JasperserverRestClient.class);
	 ...
	 * /espforum/view.php?group_id=83&forumid=101&topicid=94262
	 * 
	 * @param report
	 * @return
	 * @throws Exception
	...
	public byte[] getReportAsByte(Report reporte) throws Exception {
